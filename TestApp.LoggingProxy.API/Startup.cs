...
namespace TestApp.LoggingProxy.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.Filters.Add(new LoggingProxyExceptionFIlter());
            });

            services
                .RegisterAirTableConfiguration(Configuration)
                .RegisterAirTableMapping()
                .RegisterAirTableServices(Configuration)
                .RegisterLogEnricher();
        }
